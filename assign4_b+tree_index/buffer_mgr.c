...
void FIFO(BM_BufferPool *const bm, BM_PageHandle *const page, const  PageNumber pageNum){
    ...
    // pin page using FIFO
	// if page in buffer pool, just increase fix count of page and increment READ_IO
	// if page is not in buffer pool, add to head of queue increase fix count and increment READ_IO
